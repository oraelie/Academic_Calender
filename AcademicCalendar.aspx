<%@ Page Title="ULS Academic Calendar" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AcademicCalendar.aspx.vb" Inherits="AcademicCalendarProject.AcademicCalendar" %>
        ...
        <div class="cal-controls">
            ...
            <div class="outlook-download-box">
                ...
                <asp:HyperLink
                    ...
                    runat="server"
                    CssClass="outlook-subscribe-link"
                    ToolTip="Download a one-time .ics calendar file for Outlook"
                    Target="_blank">
